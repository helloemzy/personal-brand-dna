...
-- =====================================================
-- STEP 10: Update Triggers (SIMPLIFIED VERSION)
-- =====================================================
...
-- Create triggers one by one (avoiding the problematic loop)
DROP TRIGGER IF EXISTS update_personal_brand_frameworks_updated_at ON personal_brand_frameworks;
CREATE TRIGGER update_personal_brand_frameworks_updated_at 
BEFORE UPDATE ON personal_brand_frameworks 
...
DROP TRIGGER IF EXISTS update_post_performance_updated_at ON post_performance;
CREATE TRIGGER update_post_performance_updated_at 
BEFORE UPDATE ON post_performance 
FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_subscription_management_updated_at ON subscription_management;
CREATE TRIGGER update_subscription_management_updated_at 
BEFORE UPDATE ON subscription_management 
FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
-- NOTE: Row Level Security (RLS) policies have been removed
-- to simplify deployment. Add them later if needed.
-- =====================================================